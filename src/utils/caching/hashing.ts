...
export async function processFileHashCache(
    ...
    if (projectCache[nameFileHash] && projectCache[nameFileHash].contentHash === contentHash) {
        return {
            contentHash,
 ...
 */
export const updateFileCache = async (params: UpdateCacheParams): Promise<void> => {
