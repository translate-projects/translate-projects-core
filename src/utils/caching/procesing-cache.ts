...
import { processFileHashCache } from "./hashing";

export const ALLOWED_EXTENSIONS = [
    '.json',
];

export type ProcessDirectoryCacheOptions = {
    dir: string;
    onlyRoot?: boolean;
...
export const processDirectoryCache = async ({
    dir,
    onlyRoot = false,
    allowedExtensions = ALLOWED_EXTENSIONS,
    jsonData,
}: ProcessDirectoryCacheOptions): Promise<{
